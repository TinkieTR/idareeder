...
exports.run = async (client, message, args) => {
  ...
  if (!rol) {
    const embed = new Discord.MessageEmbed()
      .setDescription(`<a:noo:750777134548516874> **Lütfen silinecek rütbenin rolünü etiketleyiniz!**`)
.setColor('#6a00ff')
...
.setColor('#6a00ff')
    ...
    const embed = new Discord.MessageEmbed()
      .setDescription(`<a:noo:750777134548516874> **Rütbeler arasında böyle bir rütbe bulamadım!**`)
.setColor('#6a00ff')
      .setFooter(client.user.username, client.user.avatarURL);
    message.channel.send(embed);
    return;
